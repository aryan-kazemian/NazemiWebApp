...
document.addEventListener("DOMContentLoaded", function() {
  const searchModal = document.getElementById("searchModal");
  const searchInput = document.getElementById("lgScreenSearchInput");

  function showSearchModal() {
    searchModal.classList.remove("hidden", "opacity-0", "-translate-y-4");
    searchModal.classList.add("opacity-100", "translate-y-0");
  }

  function hideSearchModal() {
    searchModal.classList.add("hidden", "opacity-0", "-translate-y-4");
    searchModal.classList.remove("opacity-100", "translate-y-0");
  }
