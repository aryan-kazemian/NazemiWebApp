...
function changeSlide(direction) {
  ...
  document.getElementById("heroSectionTitle").textContent =
    titles[heroCurrentIndex];
  document.getElementById("heroSectionDes").textContent =
    descriptions[heroCurrentIndex];
  document.querySelector(".hero-button").textContent =
    buttons[heroCurrentIndex];
}
