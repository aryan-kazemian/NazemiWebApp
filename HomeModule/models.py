...
class SiteSettingsModel(models.Model):
    ...
    second_phone_number = models.CharField(max_length=20, null=True, verbose_name='شماره تماس')
    ...
    whatsapp = models.URLField(verbose_name='واتساپ', null=True)
    telegram = models.URLField(verbose_name='تلگرام', null=True)
    instagram = models.URLField(verbose_name='اینستاگرم', null=True)
